//Stolen from Ravery-net and modified
...
function PrintServerInfo(serverName, indent, prefix) {
  ...
  hacked = hacked + (_ns.getServer(serverName).backdoorInstalled?"(B)": "");
	var serverHackingLevel = _ns.getServerRequiredHackingLevel(serverName);
	var canHackIndicator = "";
	if (_ns.getHackingLevel() >= serverHackingLevel && !_ns.hasRootAccess(serverName) && serverName != "darkweb")
		canHackIndicator = "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!";
